...
Workstreams (parallel):
- [x] **Telemetry & Audits** (`logs_audits_metrics_spec.md:30-70`)
...
- [x] **Feedback APIs** (`search_spec.md:78-90`, `logs_audits_metrics_spec.md:60-80`)
...
- [ ] **SDK & CLI Updates** (`sdk_spec.md:6-28`)
  - Update Python SDK + CLI to call new ingest/search endpoints (bulk submit, job status, advanced search options). *(Python SDK updated; CLI + samples pending.)*
